    ...
    <div>
      <div id="hero" className="w-full flex items-center justify-between">
        <AnimatePresence mode="sync">
          ...
          >
            <h1>
              <span className="text-8xl font-logo">Bienvenue sur</span>
              <br />
              <span className="text-8xl font-logo">Folklore</span>
            </h1>
          </motion.div>
        </AnimatePresence>
        <AnimatePresence mode="sync">
            ...
            <div className="w-full flex items-center -mt-28">
              ...
              <div className="w-1/6 bg-orange-900 h-28 flex justify-center items-center">
                <button className="flex justify-center w-full">
                  <svg width="60px" height="60px" viewBox="0 0 91.00 91.00" id="Layer_1" version="1.1" xmlns="http://www.w3.org/2000/svg" fill="#fff" stroke="#fff" stroke-width="0.00001">
      ...
      <div className="w-1/2">
        <svg version="1.0" xmlns="http://www.w3.org/2000/svg"
          width="150px" height="20px" viewBox="0 0 1280.000000 640.000000"
